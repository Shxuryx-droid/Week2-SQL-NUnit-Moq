...
-- Note: Only one clustered index allowed; usually it's on the PRIMARY KEY.
-- If needed, drop PK and recreate it as NONCLUSTERED, or skip if allowed.
...
-- ---------------------------------------------
-- EXERCISE 3: COMPOSITE INDEX ON CustomerID + OrderDate
-- ---------------------------------------------
-- Step 1: Query before index creation
